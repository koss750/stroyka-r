    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4">
            <div class="alert alert-warning mt-5" role="alert">
                <h4 class="alert-heading">Регистрация не завершена!</h4>
                <p>Ваша заявка на регистрацию не была получена.</p>
                <p>Пожалуйста, обратитесь в службу поддержки или попробуйте еще разок.</p>
            </div>
