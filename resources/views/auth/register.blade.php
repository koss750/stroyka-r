        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6">
            <div class="card my-4">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs flex-column flex-sm-row mb-3" id="registerTabs" role="tablist">
                    ...
                    <div class="tab-content" id="registerTabsContent">
                        <div class="tab-pane fade show active" id="individual" role="tabpanel" aria-labelledby="individual-tab">
                            <div class="alert alert-info mb-4" role="alert">
                                <h4 class="alert-heading fs-5">Важное уведомление:</h4>
                                <p class="small mb-2">Вас приветствует уникальный строительный информационный ресурс Стройка.com</p>
                                <p class="small mb-2">У нас вы можете в режиме онлайн получить смету любого понравившегося вам дома или бани с ресурса и одним кликом разослать запрос на строительство в десятки строительных компаний – партнеров ресурса.</p>
                                <p class="small mb-2">Та компания что предложит вам оптимальные условия и станет воплощать вашу мечту в жизнь!</p>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch(`/api/check-company/${inn}`)
            ...
            .then(data => {
                if (data.success && data.company_name) {
                    ...
                    alert('Этот ИНН уже зарегистрирован в системе или некорректен');
                }
            })
            .catch(error => {
                console.error('Error:', error);
    ...
    // If type is 'legal', switch to legal tab
    if (type === 'legal') {
