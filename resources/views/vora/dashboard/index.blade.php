				...
				<div class="col-xl-6 col-xxl-12 col-md-6">
					<div class="card">
						...
						<div class="card-footer">
							<a href="javascript:void(0)" class="btn d-block btn-primary light dlab-load-more"   rel="{{ url('ajax/recent-activities')}}" id="RecentActivities"><strong>26</strong> Tasks More</a>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-xxl-12 col-md-6">
					<div class="card">
						...
						<div class="card-body height620 dlab-scroll" id="upcomingprojects">
							<div class="border-bottom pb-4 mb-4">
								...
								<div class="d-flex">
									<p class="font-w600 me-auto mb-2"><a href="{{ url('post-details')}}" class="text-black">Redesign Kripton Mobile App</a></p>
								...
								<div class="mb-3"><i class="fa fa-calendar-o me-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
								<div class="media align-items-center">
									<div class="d-inline-block me-3 position-relative donut-chart-sale">
										<span class="donut1" data-peity='{ "fill": ["var(--primary)", "rgba(200, 200, 200, 0.5)"],   "innerRadius": 30, "radius": 10}'>5/8</span>
							...
							<div class="border-bottom pb-4 mb-4">
								<span class="fs-14 text-primary mb-2 d-block font-w500">Yoast Esac</span>
								<div class="d-flex">
									<p class="font-w600 me-auto mb-2"><a href="{{ url('post-details')}}" class="text-black">Build Branding Persona for Etza.id</a></p>
									<div class="dropdown mb-3">
										<a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
								...
								<div class="media align-items-center">
									<div class="d-inline-block me-3 position-relative donut-chart-sale">
										<span class="donut1" data-peity='{ "fill": ["var(--primary)", "rgba(200, 200, 200, 0.5)"],   "innerRadius": 30, "radius": 10}'>2/8</span>
										<small class="text-primary fs-30">
											<i class="fa fa-bolt" aria-hidden="true"></i>
										</small>
									</div>
							...
							<div class="pb-4">
								<span class="fs-14 text-primary mb-2 d-block font-w500">Yoast Esac</span>
								<div class="d-flex">
									<p class="font-w600 me-auto mb-2"><a href="{{ url('post-details')}}" class="text-black">Manage SEO for Eclan Company Profile</a></p>
									<div class="dropdown mb-3">
										<a href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
								...
								<div class="media align-items-center">
									<div class="d-inline-block me-3 position-relative donut-chart-sale">
										<span class="donut1" data-peity='{ "fill": ["var(--primary)", "rgba(200, 200, 200, 0.5)"],   "innerRadius": 30, "radius": 10}'>7/8</span>
										<small class="text-primary fs-30">
											<i class="fa fa-bolt" aria-hidden="true"></i>
										</small>
									</div>
				...
				<div class="col-xl-12">
					<div class="card message-bx">
						<div class="card-header d-sm-flex d-block shadow-sm">
							...
							<a href="{{ url('contacts')}}" class="btn btn-primary rounded">+ New Message</a>
						</div>
						<div class="card-body">
							<div class="media mb-4">
								<div class="image-bx me-sm-4 me-2">
									<img src="{{ asset('images/users/1.png')}}" alt="" class="rounded-circle img-1">
									<span class="active"></span>
								</div>
								<div class="media-body d-sm-flex justify-content-between d-block align-items-center">
									<div class="me-sm-3 me-0">
										<h6 class="fs-16 font-w600 mb-sm-2 mb-0"><a href="{{ url('messages')}}" class="text-black">Chandara Kiev</a></h6>
									...
									<a href="{{ url('messages')}}" class="btn btn-primary light rounded mt-sm-0 mt-2">Reply</a>
								</div>
							</div>
							<div class="media mb-4">
								<div class="image-bx me-sm-4 me-2">
									<img src="{{ asset('images/users/2.png')}}" alt="" class="rounded-circle img-1">
									<span class="active"></span>
								</div>
								<div class="media-body d-sm-flex justify-content-between d-block align-items-center">
									<div class="me-sm-3 me-0">
										<h6 class="fs-16 font-w600 mb-sm-2 mb-0"><a href="{{ url('messages')}}" class="text-black">Samuel Quequeee</a></h6>
										<p class="text-black mb-sm-3 mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut</p>
							...
							<div class="media">
								...
								<div class="media-body d-sm-flex justify-content-between d-block align-items-center">
									<div class="me-sm-3 me-0">
										<h6 class="fs-16 font-w600 mb-sm-2 mb-0"><a href="{{ url('messages')}}" class="text-black">Laurenz Jumawa</a></h6>
