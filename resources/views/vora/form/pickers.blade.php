					...
					<div class="row">
						...
						<div class="col-md-6 col-xl-3 col-xxl-6 mb-3">
							...
							<div class="input-group">
								...
								<span class="input-group-btn overflow-hidden b-radius">
									<button type="button" id="check-minutes" class="btn waves-effect rounded-0 h-100 waves-light btn-ft btn-success">Check the minutes</button>
								</span>
							</div>
						</div>
