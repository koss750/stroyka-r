	...
	<div class="row">
		...
		<div class="col-xl-6">
			<div class="card text-white bg-danger">
				...
				<div class="card-body mb-0">
					<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a href="javascript:void(0);" class="light btn btn-danger btn-card">Go
						somewhere</a>
				</div>
				<div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago
				</div>
		...
		<div class="col-xl-6">
			<div class="card mb-3">
				...
				<img class="card-img-bottom img-fluid rounded-0" src="./images/card/3.png" alt="Card image cap">
				<div class="card-footer">
					<p class="card-text d-inline">Card footer</p>
					<a href="javascript:void(0);" class="card-link float-end">Card link</a>
				</div>
