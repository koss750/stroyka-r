	...
	<div class="row">
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card">
				...
				<div class="card-body px-0">
					<div id="dlab_W_TimeLine" class="widget-timeline dlab-scroll height370 px-4">
						<ul class="timeline">
							<li>
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card">
				...
				<div class="card-body px-0">
					<div id="dlab_W_TimeLine1" class="widget-timeline dlab-scroll style-1 height370 px-4">
						<ul class="timeline">
							<li>
								<div class="timeline-badge primary"></div>
								<a class="timeline-panel text-muted" href="#">
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card">
				...
				<div class="card-body px-0"> 
					<div id="dlab_W_Todo1" class="widget-media dlab-scroll height370 px-4">
						<ul class="timeline">
							<li>
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card border-0 pb-0">
				...
				<div class="card-body px-0"> 
					<div id="dlab_W_Todo2" class="widget-media dlab-scroll height370 px-4">
						<ul class="timeline">
							<li>
								<div class="timeline-panel">
									<div class="media me-2">
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card border-0 pb-0">
				...
				<div class="card-body px-0"> 
					<div id="dlab_W_Todo3" class="widget-media dlab-scroll height370 px-4">
						<ul class="timeline">
							<li>
								<div class="timeline-panel">
									<div class="media me-2">
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card border-0 pb-0">
				...
				<div class="card-body px-0"> 
					<div id="dlab_W_Todo4" class="widget-media dlab-scroll height370 px-4">
						<ul class="timeline">
							<li>
								<div class="timeline-panel">
			...
			<div class="card active_users">
				...
				<div class="card-body pt-0">
					<div class="list-group-flush mt-4">
						<div class="list-group-item border-0 bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold border-top-0">
							<p class="mb-0">Top Active Pages</p>
							<p class="mb-0">Active Users</p>
						</div>
						<div class="list-group-item border-0 bg-transparent d-flex justify-content-between px-0 py-1">
						...
						<div class="list-group-item border-0 bg-transparent d-xxl-flex justify-content-between px-0 py-1 d-none">
							<p class="mb-0">/</p>
							<p class="mb-0">2</p>
						</div>
						<div class="list-group-item border-0 bg-transparent d-xxl-flex justify-content-between px-0 py-1 d-none">
		...
		<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
			<div class="card text-white bg-primary">
				<ul class="list-group list-group-flush">
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Blood type :</span><strong>O+</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Allergies :</span><strong>Penicilin, peanuts </strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Pressure :</span><strong>120/100 mmHG</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Diseases :</span><strong>Diabetes</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Temperture :</span><strong>34 Degree</strong></li>
				</ul>
			</div>
		</div>
		<div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
			<div class="card text-white bg-warning text-black">
				<ul class="list-group list-group-flush">
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Regular Checkups</span></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Dr Theodore Handle :</span><strong>Dentist</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Dr Valentino Morose :</span><strong>Surgeon</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Dr Fleece Marigold :</span><strong>Clinical</strong></li>
					<li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Dr Eric Widget :</span><strong>Cardiology</strong></li>
				</ul>
			</div>
		</div>
		...
		<div class="col-xl-4 col-lg-12 col-sm-12">
			<div class="card overflow-hidden">
				...
				<div class="card-footer mt-0">								
					<button class="btn btn-primary btn-lg btn-block w-100">View Profile</button>		
				</div>
			</div>
		</div>
