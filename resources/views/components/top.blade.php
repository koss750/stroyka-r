        ...
        <div class="tab-content" id="registerTabsContent">
            <div class="tab-pane fade show active" id="individual" role="tabpanel" aria-labelledby="individual-tab">
                <div class="alert alert-info mb-4" role="alert">
                    ...
                    <p>У нас вы можете в режиме онлайн получить смету любого понравившегося вам дома или бани с ресурса и одним кликом разослать запрос на строительство в строительные компании – партнерам ресурса.</p>
